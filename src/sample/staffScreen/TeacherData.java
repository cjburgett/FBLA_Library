...
public class TeacherData extends RecursiveTreeObject<TeacherData> {
    ...
    public TeacherData(String id, String firstname, String lastname, String booksAllowed, String daysAllowed)
    {
